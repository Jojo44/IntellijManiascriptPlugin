...
package de.zeroclan.parser;

import com.intellij.lang.PsiBuilder;
import com.intellij.lang.PsiBuilder.Marker;
import com.intellij.openapi.diagnostic.Logger;
import static de.zeroclan.psi.ManiascriptTypes.*;
...
public class ManiascriptParser implements PsiParser {

  public static final Logger LOG_ = Logger.getInstance("de.zeroclan.parser.ManiascriptParser");
  ...
  protected boolean parse_root_(final IElementType root_, final PsiBuilder builder_, final int level_) {
    return maniascriptFile(builder_, level_ + 1);
  }
  ...
  /* ********************************************************** */
  // item_*
  static boolean maniascriptFile(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "maniascriptFile")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!item_(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "maniascriptFile", pos_)) break;
