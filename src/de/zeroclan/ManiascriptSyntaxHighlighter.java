 ...
 */
public class ManiascriptSyntaxHighlighter extends SyntaxHighlighterBase
{
    ...
    public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
        if (tokenType.equals(ManiascriptTypes.SEPARATOR)) {
            return SEPARATOR_KEYS;
        } else if (tokenType.equals(ManiascriptTypes.KEY)) {
            return KEY_KEYS;
        } else if (tokenType.equals(ManiascriptTypes.VALUE)) {
            return VALUE_KEYS;
        } else if (tokenType.equals(ManiascriptTypes.COMMENT)) {
            return COMMENT_KEYS;
